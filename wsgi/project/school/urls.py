...
from .views import SchoolMenuView, SchoolCurriculumView, SchoolYearView, SchoolNewslettersListView, SchoolPoliciesListView, SchoolStatutoryInfoListView, SchoolPerformanceListView
